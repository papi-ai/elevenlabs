...
- **Implement core interfaces** — TextToSpeechProviderInterface from papi-core
- **Immutable value objects** — use core AudioResponse type
...
- Test message conversion, option handling, response parsing
